...
For Tailwind UI patterns and premium styling, reference `.claude/skills/frontend/tailwind-ui-patterns.md` and `.claude/skills/frontend/design-system-guide.md`.
...
For detailed Tailwind and premium UX patterns, reference:
