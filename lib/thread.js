...
async function classifyMessage(app, channel, threadTs, messages, context) {
  ...
  const prompt = [
    ...
    '  Extract the project name from the repo URL or name. For GitHub URLs like',
    '  "git@github.com:org/name.git" or "https://github.com/org/name", extract just "name".',
    '  Examples: "onboard my project eastvillageeverything",',
    '  "git@github.com:gulati8/myapp.git", "connect this repo https://github.com/org/app"',
    '- "create": The user wants to create a BRAND NEW project from scratch.',
    '  Examples: "create a new project called myapp", "build me a weather dashboard",',
    '  "new project: task-tracker"',
